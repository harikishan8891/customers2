...
,p_last_upd_yyyymmddhh24miss=>'20231002152202'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1611697631774273273)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17798877360976718505)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17800974559514026510)
,p_plug_name=>'Audit Information'
,p_parent_plug_id=>wwv_flow_imp.id(17798877360976718505)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798877684789718514)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1611697631774273273)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798877570978718514)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798877968322718517)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798877765841718514)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17798878762852718544)
,p_name=>'P9_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_imp.id(17798877360976718505)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17798878960875718564)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800975368517029055)
,p_name=>'P9_CREATED'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17800974559514026510)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800976242676031063)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800977251680033690)
,p_name=>'P9_UPDATED'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(17800974559514026510)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800978261030036379)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17834256069539218311)
,p_name=>'P9_IS_ACTIVE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17798877360976718505)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(15061332396646410190)
...
,p_associated_item=>wwv_flow_imp.id(17798878960875718564)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(17826863144687629127)
...
,p_when_button_pressed=>wwv_flow_imp.id(17798877765841718514)
,p_associated_item=>wwv_flow_imp.id(17798878960875718564)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1611697708601273274)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(17798877968322718517)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1611697859577273275)
,p_event_id=>wwv_flow_imp.id(1611697708601273274)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798879483627718572)
...
,p_internal_uid=>17798879483627718572
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798879667672718574)
...
,p_internal_uid=>17798879667672718574
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798879870386718574)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_imp.id(17798877765841718514)
,p_internal_uid=>17798879870386718574
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1611697940881273276)
...
,p_internal_uid=>1611697940881273276
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798286631026303127)
,p_process_sequence=>50
...
,p_internal_uid=>17798286631026303127
);
