...
,p_last_upd_yyyymmddhh24miss=>'20231002151642'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1611696982214273267)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17798848762045760828)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17800482656995592460)
,p_plug_name=>'Audit Information'
,p_parent_plug_id=>wwv_flow_imp.id(17798848762045760828)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798849072118760839)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1611696982214273267)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798848969845760839)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798849355551760863)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17798849154250760839)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17798850161805760886)
,p_name=>'P4_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_imp.id(17798848762045760828)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17798850376150760906)
,p_name=>'P4_CATEGORY'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(17798848762045760828)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17798850759312760919)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800487460374612289)
,p_name=>'P4_CREATED'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(17800482656995592460)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800489067300614322)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800490841112616259)
,p_name=>'P4_UPDATED'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(17800482656995592460)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17800492448730618464)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17834243639674188206)
,p_name=>'P4_IS_ACTIVE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17798848762045760828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(15061330490200382849)
...
,p_associated_item=>wwv_flow_imp.id(17798850376150760906)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(17826601545571302318)
...
,p_when_button_pressed=>wwv_flow_imp.id(17798849154250760839)
,p_associated_item=>wwv_flow_imp.id(17798850376150760906)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1611697096363273268)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(17798849355551760863)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1611697179575273269)
,p_event_id=>wwv_flow_imp.id(1611697096363273268)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798851279705760927)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798851472626760933)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798851653185760935)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_imp.id(17798849154250760839)
,p_internal_uid=>17798851653185760935
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1611697323051273270)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17798275339105163631)
,p_process_sequence=>50
