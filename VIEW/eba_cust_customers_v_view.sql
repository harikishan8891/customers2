CREATE OR REPLACE FORCE EDITIONABLE VIEW "%USER_NAME%"."EBA_CUST_CUSTOMERS_V" 
 ( "ROW_KEY", "ID", "CUSTOMER_NAME", "STATUS", "STATUS_ID", "CATEGORY", "GEOGRAPHY_NAME", "REFERENCABLE", "NUMBER_OF_USERS", "SUMMARY", "WEB_SITE", "PRODUCT_USES", "INDUSTRY", "TAGS", "CREATED", "CREATED_BY", "UPDATED", "UPDATED_BY"
  )  AS 
  select 
   a.row_key, 
   a.id,
