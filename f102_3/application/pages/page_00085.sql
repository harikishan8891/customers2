...
,p_last_upd_yyyymmddhh24miss=>'20231002153305'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1104458395534313262)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1104458549752313263)
,p_region_id=>wwv_flow_imp.id(1104458395534313262)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1104458589614313264)
,p_chart_id=>wwv_flow_imp.id(1104458549752313263)
,p_seq=>10
,p_name=>'Geography'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1104458695426313265)
,p_chart_id=>wwv_flow_imp.id(1104458549752313263)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1104458839847313266)
,p_chart_id=>wwv_flow_imp.id(1104458549752313263)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15769488415988313541)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15868583626043802955)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15872463863806729989)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15769488415988313541)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15868583892839802956)
,p_name=>'P85_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(15868583626043802955)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15868728793681924190)
,p_name=>'set cat'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1104458956460313267)
,p_event_id=>wwv_flow_imp.id(15868728793681924190)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1104458395534313262)
);
