   ...
   COMMENT ON COLUMN "EBA_CUST_CUSTOMERS"."ID" IS 'Primary Key, never changes.  Automatically generated by Oracle Database';
   COMMENT ON COLUMN "EBA_CUST_CUSTOMERS"."CUSTOMER_NAME" IS 'The name for the Customer.';
